...
public class plusOneInt extends Talent {
    public plusOneInt(String cla, int minLvl) {
        super("Wizard", 1, R.drawable.plusoneint, R.drawable.plusoneintyes);
    }
