...
public class ExploreTheMinePartOneActivity extends AppCompatActivity {
    ...
    Fragment SlayTheBigRatStoryPartOneFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explore_the_mine);
        ...
        loadFragment(new ExploreTheMinePartOneFragment());
...
// replace the FrameLayout with new Fragment
    ...
    public void continueQuest(View view) {
        if (levelComplete == 1) {
            ...
            Intent confirmIntent = new Intent(ExploreTheMinePartOneActivity.this, SlayTheBigRatPartTwoActivity.class);
