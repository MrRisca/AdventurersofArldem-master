...
public class ExploreTheMineQuest extends Quest {
    private static int questExperience = 30;
    ...
    public static int questGold = 50;

    public ExploreTheMineQuest() {
    }
    ...
    public void startQuest(Activity activity){
        Intent confirmIntent = new Intent(activity, ExploreTheMinePartOneActivity.class);
    }
