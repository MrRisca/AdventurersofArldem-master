...
public class SlayTheBigRatPartTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slay_the_big_rat_part_two);
        ...
        loadFragment(new SlayTheBigRatStoryPartTwoFragment());
...
// replace the FrameLayout with new Fragment
    ...
    public void continueQuest(View view) {
        if (levelComplete == 1) {
            ...
            loadFragment(new SlayTheBigRatStoryPartThreeFragment());
