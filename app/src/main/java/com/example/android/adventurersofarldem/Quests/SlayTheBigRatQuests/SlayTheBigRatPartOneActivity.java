...
public class SlayTheBigRatPartOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new SlayTheBigRatStoryPartOneFragment());
...
// replace the FrameLayout with new Fragment
    ...
    public void continueQuest(View view) {
        if (levelComplete == 1) {
            ...
            Intent confirmIntent = new Intent(SlayTheBigRatPartOneActivity.this, SlayTheBigRatPartTwoActivity.class);
